...
describe("Config cap_slots", function()
  it("is on by default", function()
    assert.is_true(Config.defaults().cap_slots)
  end)

  it("round-trips through normalize", function()
    assert.is_false(Config.normalize({ cap_slots = false }, valid).cap_slots)
    assert.is_true(Config.normalize({}, valid).cap_slots)
  end)
end)
